...
def locus_predictor(attitude=None, walk_direction_bias=0,
    ...
    def predict(locus: PedestrianLocus):
        ...
        info["bias"] = {
            ...
            'test0':[ 0.05145480840887835 ,  0.14256683061981462 ,  -0.00019274882217566887 ,  0.1580803622203427 ],
            #[ 0.10173851027202052 ,  0.3694584517062576 ,  0.00012496803430760844 ,  0.16246206630622262 ],
        }
        info['bias_only']={
            'test0': [0.05145480840887835, 0.407, 0.00013175, 0.18018],
            'test1': [3.14536252, 0.407, 0.00013175, 0.18018],
            'test2': [ 1.59390685,  0.407 ,  0.00013175 ,  0.18018 ],
            'test3': [ 0.08072592 ,  0.407 ,  0.00013175 ,  0.18018 ],
            'test5': [ -2.81174281 ,  0.407 ,  0.00013175 ,  0.18018 ],
            'test6': [ -0.10937963 ,  0.407 ,  0.00013175 ,  0.18018 ],
            'test7': [ -3.29710369 ,  0.407 ,  0.00013175 ,  0.18018 ],
            'test8': [ 0.10725114 ,  0.407 ,  0.00013175 ,  0.18018 ],
            'test9': [ 0.36949971 ,  0.407 ,  0.00013175 ,  0.18018 ],
            'test10': [ 0.2429654 ,  0.407 ,  0.00013175 ,  0.18018 ],
            'test11': [ 1.75,  0.407 ,  0.00013175 ,  0.18018 ],
        }
        info['args'] = {
            'test0': ("ZXY", None),
            'test1': ("ZYX", None),
